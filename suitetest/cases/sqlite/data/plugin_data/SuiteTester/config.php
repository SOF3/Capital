...
return function() {
    ...
    yield from pay_money_test($context, "alice", "bob", 3, 97, 103);
    yield from add_money_test($context, "alice", "bob", 10, 113);
    yield from take_money_test($context, "alice", "alice", 15, 82);
