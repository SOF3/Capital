...
final class CommandTransferMethod implements TransferMethod {
     ...
     * @param ParameterizedLabelSelector<TransferContextInfo> $src Selects the accounts to take money from.
     * @param ParameterizedLabelSelector<TransferContextInfo> $dest Selects the accounts to send money to.
     ...
     * @param ParameterizedLabelSet<TransferContextInfo> $transactionLabels The labels set on the transaction.
